...
This repo already includes `render.yaml` to help with that.
...
Make sure SPA routing rewrites to `index.html` — that rewrite is already included in `render.yaml`.
