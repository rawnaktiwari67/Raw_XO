...
import { getQuestion, getSession, getDaily, submitAnswer, getLeaderboard, getHistory, getStats, rateTrack, getArtists, searchArtists } from '../controllers/game.controller';
...
router.get('/daily', optionalProtect, getDaily);
